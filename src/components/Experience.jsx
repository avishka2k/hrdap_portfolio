...
function ExperienceItem() {
  return (
    <div className="flex gap-5">
      <div className="">
        <FaGraduationCap className="bg-app_primary bottom-[-2rem] text-app_white w-14 h-14 p-3 rounded-full" />
      </div>
      <div className="mt-5">
        <p className="uppercase font-semibold mb-4 items-center flex">
          api development
          <span className="bg-app_primary font-medium text-xs py-1 px-4 text-app_white rounded-full ml-3">
            NSBM
          </span>
        </p>
        <p className=" text-app_gray font-light text-xs mb-3">
          Promote your blog posts. case udie. and product ounces nts with these
          branded videos.
        </p>
        <p className="flex items-center gap-1 text-xs text-app_primary">
          <div className="w-[4px] h-[4px] bg-app_primary"></div>2023
        </p>
      </div>
    </div>
  );
